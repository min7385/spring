                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="name:required">아이디는 필수 입니다.</div>
                            </div>
                            <!-- Password input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="email" type="email" placeholder="name@example.com" data-sb-validations="required,email" />
                                <label for="Password">Password</label>
                                <div class="invalid-feedback" data-sb-feedback="email:required">비밀번호는 필수 입니다.</div>
                            </div>
                            <!-- Name input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="tel" placeholder="(123) 456-7890" data-sb-validations="required" />
                                <label for="Name">Name</label>
                                <div class="invalid-feedback" data-sb-feedback="phone:required">이름은 필수 입니다.</div>
                            </div>
