...
public class FreeBoardSearchVO extends PagingVO{
	...
	public String toString() {
		return "FreeBoardSearchVO [searchWord=" + searchWord + ", searchType=" + searchType + ", searchCategory="
				+ searchCategory + ", getSearchWord()=" + getSearchWord() + ", getSearchType()=" + getSearchType()
				+ ", getSearchCategory()=" + getSearchCategory() + ", getCurPage()=" + getCurPage()
				+ ", getRowSizePerPage()=" + getRowSizePerPage() + ", getPageSize()=" + getPageSize()
				+ ", getTotalRowCount()=" + getTotalRowCount() + ", getFirstRow()=" + getFirstRow() + ", getLastRow()="
				+ getLastRow() + ", getTotalPageCount()=" + getTotalPageCount() + ", getFirstPage()=" + getFirstPage()
