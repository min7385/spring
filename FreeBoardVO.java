...
public class FreeBoardVO {
	...
	public String toString() {
		return "FreeBoardVO [boNo=" + boNo + ", boTitle=" + boTitle + ", boCategory=" + boCategory + ", boCategoryNm="
				...
				+ ", boDelYn=" + boDelYn + ", getBoNo()=" + getBoNo() + ", getBoTitle()=" + getBoTitle()
				+ ", getBoCategory()=" + getBoCategory() + ", getBoCategoryNm()=" + getBoCategoryNm()
				+ ", getBoWriter()=" + getBoWriter() + ", getBoPass()=" + getBoPass() + ", getBoContent()="
				+ getBoContent() + ", getBoIp()=" + getBoIp() + ", getBoHit()=" + getBoHit() + ", getBoRegDate()="
				+ getBoRegDate() + ", getBoModDate()=" + getBoModDate() + ", getBoDelYn()=" + getBoDelYn()
